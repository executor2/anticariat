...
use Shop\AnticariatBundle\Entity\Book;
use Shop\AnticariatBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ShopAnticariatBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("ShopAnticariatBundle:Book:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ShopAnticariatBundle:Book')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ShopAnticariatBundle:Book:edit.html.twig")
     */
